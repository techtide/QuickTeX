...
- [x] A lightweight extension with a non-intrusive GUI, available in both the Chrome and [Firefox](https://addons.mozilla.org/en-US/firefox/addon/quicktex/) extension stores.
